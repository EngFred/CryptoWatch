...
-keep class com.engfred.cryptowatch.data.remote.** { *; }

# Keep all Local Entities (Room)
-keep class com.engfred.cryptowatch.data.local.** { *; }

# Keep Domain Models (if used in UI/Reflection)
-keep class com.engfred.cryptowatch.domain.model.** { *; }
...
# 5. Hilt & WorkManager
# ----------------------------------------------------------------------------
# Keep the Worker constructor so WorkManager can create it via reflection
-keep class * extends androidx.work.ListenableWorker {
    public <init>(android.content.Context, androidx.work.WorkerParameters);
}

# Keep the Application class entry point
-keep class com.engfred.cryptowatch.CryptoApplication { *; }
